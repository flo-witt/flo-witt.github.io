...
permalink: /publication/2025-08-29-unsupervised-automata-learning-via-discrete-optimization
excerpt: 'Learning finite automata from unlabeled data using discrete optimization techniques.'
date: 2025-08-29
venue: 'JELIA'
paperurl: 'https://doi.org/10.1007/978-3-032-04587-4_9'
bibtexurl: 'https://flo-witt.github.io/files/automata-learning-25.bib'
citation: 'Lutz, S. et al. (2026). Unsupervised Automata Learning via Discrete Optimization. In: Casini, G., Dundua, B., Kutsia, T. (eds) Logics in Artificial Intelligence. JELIA 2025. Lecture Notes in Computer Science(), vol 16093. Springer, Cham.'
---
